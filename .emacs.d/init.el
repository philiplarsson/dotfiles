...
(custom-set-variables
 ...
 '(package-selected-packages
   '(lsp-ivy paredit dash-at-point web-mode go-mode docker-compose-mode golden-ratio markdown-mode ace-window slime undo-tree smartparens aggressive-indent git-gutter exec-path-from-shell typescript-mode dockerfile-mode counsel-projectile projectile smex counsel ivy crux avy which-key doom-themes))
 '(tool-bar-mode nil))
(custom-set-faces
